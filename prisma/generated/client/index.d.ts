...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "users" | "product" | "category" | "order" | "order_item" | "payment" | "review" | "address" | "shipping_address" | "wishlist" | "wishlist_item" | "settings"
  ...
  export type settingsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"type" | "value" | "created_at" | "updated_at", ExtArgs["result"]["settings"]>
  ...
  export interface settingsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const settingsWithTypeOnly = await prisma.settings.findMany({ select: { type: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Settings and only return the `type`
     * const settingsWithTypeOnly = await prisma.settings.createManyAndReturn({
     *   select: { type: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Settings and only return the `type`
     * const settingsWithTypeOnly = await prisma.settings.updateManyAndReturn({
     *   select: { type: true },
     *   where: {
     *     // ... provide filter here
     *   },
